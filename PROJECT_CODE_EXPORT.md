# Cyberpunk Vocab Flashcards - Complete Project Code
...
1. ✅ Added missing `@google/genai` dependency
2. ✅ Removed conflicting import map from HTML that was causing module resolution issues
3. ✅ All TypeScript type checking passes
...
- The AI context feature requires a Gemini API key to function
- Data is stored locally in the browser and is not synchronized across devices
- The app uses a cyberpunk aesthetic with custom neon effects
